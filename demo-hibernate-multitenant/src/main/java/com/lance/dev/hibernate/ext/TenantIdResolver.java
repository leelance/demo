...
public class TenantIdResolver implements CurrentTenantIdentifierResolver {
    ...
    public String resolveCurrentTenantIdentifier() {
        logger.debug("----------resolveCurrentTenantIdentifier----------{}", ContextHolder.newInstance().getContext());
        if(StringUtils.isNotBlank(ContextHolder.newInstance().getContext())) {
            return ContextHolder.newInstance().getContext();
        }
